...
export const metadata: Metadata = {
  title: "Solar Panels Annagassan | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Annagassan and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsAnnagassanPage() {
  const location = getSolarLocationBySlug("annagassan");
