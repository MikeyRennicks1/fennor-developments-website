...
export const metadata: Metadata = {
  title: "Solar Panels Ardcath | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Ardcath and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsArdcathPage() {
  const location = getSolarLocationBySlug("ardcath");
