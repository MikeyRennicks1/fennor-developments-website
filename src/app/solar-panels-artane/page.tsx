...
export const metadata: Metadata = {
  title: "Solar Panels Artane | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Artane and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsArtanePage() {
  const location = getSolarLocationBySlug("artane");
