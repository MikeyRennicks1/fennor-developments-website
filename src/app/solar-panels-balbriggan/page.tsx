...
export const metadata: Metadata = {
  title: "Solar Panels Balbriggan | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Balbriggan and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBalbrigganPage() {
  const location = getSolarLocationBySlug("balbriggan");
