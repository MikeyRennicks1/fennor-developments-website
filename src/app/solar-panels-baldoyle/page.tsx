...
export const metadata: Metadata = {
  title: "Solar Panels Baldoyle | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Baldoyle and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBaldoylePage() {
  const location = getSolarLocationBySlug("baldoyle");
