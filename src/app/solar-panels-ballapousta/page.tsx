...
export const metadata: Metadata = {
  title: "Solar Panels Ballapousta | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Ballapousta and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBallapoustaPage() {
  const location = getSolarLocationBySlug("ballapousta");
