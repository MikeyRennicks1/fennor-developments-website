...
export const metadata: Metadata = {
  title: "Solar Panels Ballinlough | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Ballinlough and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBallinloughPage() {
  const location = getSolarLocationBySlug("ballinlough");
