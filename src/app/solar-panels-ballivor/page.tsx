...
export const metadata: Metadata = {
  title: "Solar Panels Ballivor | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Ballivor and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBallivorPage() {
  const location = getSolarLocationBySlug("ballivor");
