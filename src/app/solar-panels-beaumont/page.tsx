...
export const metadata: Metadata = {
  title: "Solar Panels Beaumont | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Beaumont and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBeaumontPage() {
  const location = getSolarLocationBySlug("beaumont");
