...
export const metadata: Metadata = {
  title: "Solar Panels Bective | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Bective and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBectivePage() {
  const location = getSolarLocationBySlug("bective");
