...
export const metadata: Metadata = {
  title: "Solar Panels Bellewstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Bellewstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBellewstownPage() {
  const location = getSolarLocationBySlug("bellewstown");
