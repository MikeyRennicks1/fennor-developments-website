...
export const metadata: Metadata = {
  title: "Solar Panels Bellurgan | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Bellurgan and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBellurganPage() {
  const location = getSolarLocationBySlug("bellurgan");
