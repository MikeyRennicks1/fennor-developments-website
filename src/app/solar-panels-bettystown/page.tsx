...
export const metadata: Metadata = {
  title: "Solar Panels Bettystown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Bettystown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBettystownPage() {
  const location = getSolarLocationBySlug("bettystown");
