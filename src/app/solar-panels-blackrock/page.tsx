...
export const metadata: Metadata = {
  title: "Solar Panels Blackrock | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Blackrock and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBlackrockPage() {
  const location = getSolarLocationBySlug("blackrock");
