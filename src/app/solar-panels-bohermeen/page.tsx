...
export const metadata: Metadata = {
  title: "Solar Panels Bohermeen | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Bohermeen and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsBohermeenPage() {
  const location = getSolarLocationBySlug("bohermeen");
