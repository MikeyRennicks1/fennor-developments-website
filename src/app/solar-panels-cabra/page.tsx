...
export const metadata: Metadata = {
  title: "Solar Panels Cabra | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Cabra and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCabraPage() {
  const location = getSolarLocationBySlug("cabra");
