...
export const metadata: Metadata = {
  title: "Solar Panels Carlanstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Carlanstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCarlanstownPage() {
  const location = getSolarLocationBySlug("carlanstown");
