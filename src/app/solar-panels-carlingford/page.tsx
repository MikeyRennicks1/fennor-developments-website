...
export const metadata: Metadata = {
  title: "Solar Panels Carlingford | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Carlingford and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCarlingfordPage() {
  const location = getSolarLocationBySlug("carlingford");
