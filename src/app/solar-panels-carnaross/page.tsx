...
export const metadata: Metadata = {
  title: "Solar Panels Carnaross | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Carnaross and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCarnarossPage() {
  const location = getSolarLocationBySlug("carnaross");
