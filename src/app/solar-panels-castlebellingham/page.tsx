...
export const metadata: Metadata = {
  title: "Solar Panels Castlebellingham | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Castlebellingham and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCastlebellinghamPage() {
  const location = getSolarLocationBySlug("castlebellingham");
