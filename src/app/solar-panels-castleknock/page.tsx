...
export const metadata: Metadata = {
  title: "Solar Panels Castleknock | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Castleknock and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCastleknockPage() {
  const location = getSolarLocationBySlug("castleknock");
