...
export const metadata: Metadata = {
  title: "Solar Panels Castletown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Castletown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCastletownPage() {
  const location = getSolarLocationBySlug("castletown");
