...
export const metadata: Metadata = {
  title: "Solar Panels Chanonrock | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Chanonrock and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsChanonrockPage() {
  const location = getSolarLocationBySlug("chanonrock");
