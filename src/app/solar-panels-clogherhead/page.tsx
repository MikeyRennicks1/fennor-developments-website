...
export const metadata: Metadata = {
  title: "Solar Panels Clogherhead | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Clogherhead and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsClogherheadPage() {
  const location = getSolarLocationBySlug("clogherhead");
