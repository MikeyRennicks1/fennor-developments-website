...
export const metadata: Metadata = {
  title: "Solar Panels Clonee | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Clonee and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCloneePage() {
  const location = getSolarLocationBySlug("clonee");
