...
export const metadata: Metadata = {
  title: "Solar Panels Clongriffin | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Clongriffin and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsClongriffinPage() {
  const location = getSolarLocationBySlug("clongriffin");
