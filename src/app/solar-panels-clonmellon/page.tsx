...
export const metadata: Metadata = {
  title: "Solar Panels Clonmellon | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Clonmellon and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsClonmellonPage() {
  const location = getSolarLocationBySlug("clonmellon");
