...
export const metadata: Metadata = {
  title: "Solar Panels Clonsilla | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Clonsilla and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsClonsillaPage() {
  const location = getSolarLocationBySlug("clonsilla");
