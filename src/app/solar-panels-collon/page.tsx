...
export const metadata: Metadata = {
  title: "Solar Panels Collon | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Collon and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCollonPage() {
  const location = getSolarLocationBySlug("collon");
