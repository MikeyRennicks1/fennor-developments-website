...
export const metadata: Metadata = {
  title: "Solar Panels Coolock | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Coolock and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCoolockPage() {
  const location = getSolarLocationBySlug("coolock");
