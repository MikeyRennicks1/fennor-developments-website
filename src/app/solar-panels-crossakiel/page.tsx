...
export const metadata: Metadata = {
  title: "Solar Panels Crossakiel | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Crossakiel and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsCrossakielPage() {
  const location = getSolarLocationBySlug("crossakiel");
