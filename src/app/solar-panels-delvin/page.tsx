...
export const metadata: Metadata = {
  title: "Solar Panels Delvin | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Delvin and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDelvinPage() {
  const location = getSolarLocationBySlug("delvin");
