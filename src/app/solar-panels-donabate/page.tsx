...
export const metadata: Metadata = {
  title: "Solar Panels Donabate | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Donabate and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDonabatePage() {
  const location = getSolarLocationBySlug("donabate");
