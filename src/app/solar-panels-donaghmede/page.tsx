...
export const metadata: Metadata = {
  title: "Solar Panels Donaghmede | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Donaghmede and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDonaghmedePage() {
  const location = getSolarLocationBySlug("donaghmede");
