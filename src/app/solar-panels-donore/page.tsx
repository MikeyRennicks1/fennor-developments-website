...
export const metadata: Metadata = {
  title: "Solar Panels Donore | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Donore and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDonorePage() {
  const location = getSolarLocationBySlug("donore");
