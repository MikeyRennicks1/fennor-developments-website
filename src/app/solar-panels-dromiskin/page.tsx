...
export const metadata: Metadata = {
  title: "Solar Panels Dromiskin | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Dromiskin and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDromiskinPage() {
  const location = getSolarLocationBySlug("dromiskin");
