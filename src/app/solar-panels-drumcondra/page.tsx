...
export const metadata: Metadata = {
  title: "Solar Panels Drumcondra | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Drumcondra and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDrumcondraPage() {
  const location = getSolarLocationBySlug("drumcondra");
