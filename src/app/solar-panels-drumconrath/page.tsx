...
export const metadata: Metadata = {
  title: "Solar Panels Drumconrath | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Drumconrath and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDrumconrathPage() {
  const location = getSolarLocationBySlug("drumconrath");
