...
export const metadata: Metadata = {
  title: "Solar Panels Drumree | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Drumree and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDrumreePage() {
  const location = getSolarLocationBySlug("drumree");
