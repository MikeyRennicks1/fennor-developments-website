...
export const metadata: Metadata = {
  title: "Solar Panels Duleek | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Duleek and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDuleekPage() {
  const location = getSolarLocationBySlug("duleek");
