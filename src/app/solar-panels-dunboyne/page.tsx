...
export const metadata: Metadata = {
  title: "Solar Panels Dunboyne | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Dunboyne and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDunboynePage() {
  const location = getSolarLocationBySlug("dunboyne");
