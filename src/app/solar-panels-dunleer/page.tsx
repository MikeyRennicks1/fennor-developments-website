...
export const metadata: Metadata = {
  title: "Solar Panels Dunleer | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Dunleer and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDunleerPage() {
  const location = getSolarLocationBySlug("dunleer");
