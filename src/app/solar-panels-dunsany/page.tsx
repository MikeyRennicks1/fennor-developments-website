...
export const metadata: Metadata = {
  title: "Solar Panels Dunsany | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Dunsany and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsDunsanyPage() {
  const location = getSolarLocationBySlug("dunsany");
