...
export const metadata: Metadata = {
  title: "Solar Panels Enfield | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Enfield and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsEnfieldPage() {
  const location = getSolarLocationBySlug("enfield");
