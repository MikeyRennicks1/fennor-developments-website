...
export const metadata: Metadata = {
  title: "Solar Panels Faughart | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Faughart and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsFaughartPage() {
  const location = getSolarLocationBySlug("faughart");
