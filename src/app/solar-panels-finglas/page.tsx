...
export const metadata: Metadata = {
  title: "Solar Panels Finglas | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Finglas and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsFinglasPage() {
  const location = getSolarLocationBySlug("finglas");
