...
export const metadata: Metadata = {
  title: "Solar Panels Fordstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Fordstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsFordstownPage() {
  const location = getSolarLocationBySlug("fordstown");
