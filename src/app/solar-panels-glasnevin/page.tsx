...
export const metadata: Metadata = {
  title: "Solar Panels Glasnevin | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Glasnevin and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsGlasnevinPage() {
  const location = getSolarLocationBySlug("glasnevin");
