...
export const metadata: Metadata = {
  title: "Solar Panels Gormanston | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Gormanston and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsGormanstonPage() {
  const location = getSolarLocationBySlug("gormanston");
