...
export const metadata: Metadata = {
  title: "Solar Panels Grangebellew | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Grangebellew and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsGrangebellewPage() {
  const location = getSolarLocationBySlug("grangebellew");
