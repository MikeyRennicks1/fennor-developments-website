...
export const metadata: Metadata = {
  title: "Solar Panels Greenore | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Greenore and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsGreenorePage() {
  const location = getSolarLocationBySlug("greenore");
