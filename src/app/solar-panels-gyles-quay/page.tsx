...
export const metadata: Metadata = {
  title: "Solar Panels Gyles Quay | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Gyles Quay and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsGylesQuayPage() {
  const location = getSolarLocationBySlug("gyles-quay");
