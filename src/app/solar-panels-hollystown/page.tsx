...
export const metadata: Metadata = {
  title: "Solar Panels Hollystown | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Hollystown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsHollystownPage() {
  const location = getSolarLocationBySlug("hollystown");
