...
export const metadata: Metadata = {
  title: "Solar Panels Howth | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Howth and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsHowthPage() {
  const location = getSolarLocationBySlug("howth");
