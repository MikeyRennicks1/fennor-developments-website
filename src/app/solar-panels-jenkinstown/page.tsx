...
export const metadata: Metadata = {
  title: "Solar Panels Jenkinstown | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Jenkinstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsJenkinstownPage() {
  const location = getSolarLocationBySlug("jenkinstown");
