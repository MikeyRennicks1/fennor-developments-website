...
export const metadata: Metadata = {
  title: "Solar Panels Julianstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Julianstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsJulianstownPage() {
  const location = getSolarLocationBySlug("julianstown");
