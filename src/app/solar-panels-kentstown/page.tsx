...
export const metadata: Metadata = {
  title: "Solar Panels Kentstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Kentstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKentstownPage() {
  const location = getSolarLocationBySlug("kentstown");
