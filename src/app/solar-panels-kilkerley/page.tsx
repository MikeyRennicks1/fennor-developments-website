...
export const metadata: Metadata = {
  title: "Solar Panels Kilkerley | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Kilkerley and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKilkerleyPage() {
  const location = getSolarLocationBySlug("kilkerley");
