...
export const metadata: Metadata = {
  title: "Solar Panels Kilmainhamwood | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Kilmainhamwood and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKilmainhamwoodPage() {
  const location = getSolarLocationBySlug("kilmainhamwood");
