...
export const metadata: Metadata = {
  title: "Solar Panels Kilmessan | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Kilmessan and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKilmessanPage() {
  const location = getSolarLocationBySlug("kilmessan");
