...
export const metadata: Metadata = {
  title: "Solar Panels Kilskyre | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Kilskyre and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKilskyrePage() {
  const location = getSolarLocationBySlug("kilskyre");
