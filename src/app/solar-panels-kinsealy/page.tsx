...
export const metadata: Metadata = {
  title: "Solar Panels Kinsealy | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Kinsealy and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKinsealyPage() {
  const location = getSolarLocationBySlug("kinsealy");
