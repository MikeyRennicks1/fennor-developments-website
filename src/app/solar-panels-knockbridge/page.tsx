...
export const metadata: Metadata = {
  title: "Solar Panels Knockbridge | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Knockbridge and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsKnockbridgePage() {
  const location = getSolarLocationBySlug("knockbridge");
