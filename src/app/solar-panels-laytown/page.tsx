...
export const metadata: Metadata = {
  title: "Solar Panels Laytown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Laytown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsLaytownPage() {
  const location = getSolarLocationBySlug("laytown");
