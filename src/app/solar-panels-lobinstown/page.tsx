...
export const metadata: Metadata = {
  title: "Solar Panels Lobinstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Lobinstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsLobinstownPage() {
  const location = getSolarLocationBySlug("lobinstown");
