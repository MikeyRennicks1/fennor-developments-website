...
export const metadata: Metadata = {
  title: "Solar Panels Longwood | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Longwood and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsLongwoodPage() {
  const location = getSolarLocationBySlug("longwood");
