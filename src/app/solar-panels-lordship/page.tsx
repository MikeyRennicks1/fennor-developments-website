...
export const metadata: Metadata = {
  title: "Solar Panels Lordship | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Lordship and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsLordshipPage() {
  const location = getSolarLocationBySlug("lordship");
