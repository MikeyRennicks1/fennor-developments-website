...
export const metadata: Metadata = {
  title: "Solar Panels Louth Village | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Louth Village and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsLouthVillagePage() {
  const location = getSolarLocationBySlug("louth-village");
