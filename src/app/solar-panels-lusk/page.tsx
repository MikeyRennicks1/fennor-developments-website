...
export const metadata: Metadata = {
  title: "Solar Panels Lusk | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Lusk and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsLuskPage() {
  const location = getSolarLocationBySlug("lusk");
