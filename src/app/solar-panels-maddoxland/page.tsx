...
export const metadata: Metadata = {
  title: "Solar Panels Maddoxland | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Maddoxland and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMaddoxlandPage() {
  const location = getSolarLocationBySlug("maddoxland");
