...
export const metadata: Metadata = {
  title: "Solar Panels Malahide | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Malahide and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMalahidePage() {
  const location = getSolarLocationBySlug("malahide");
