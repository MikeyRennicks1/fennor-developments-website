...
export const metadata: Metadata = {
  title: "Solar Panels Monasterboice | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Monasterboice and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMonasterboicePage() {
  const location = getSolarLocationBySlug("monasterboice");
