...
export const metadata: Metadata = {
  title: "Solar Panels Mornington | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Mornington and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMorningtonPage() {
  const location = getSolarLocationBySlug("mornington");
