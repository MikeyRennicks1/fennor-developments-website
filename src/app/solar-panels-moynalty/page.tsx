...
export const metadata: Metadata = {
  title: "Solar Panels Moynalty | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Moynalty and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMoynaltyPage() {
  const location = getSolarLocationBySlug("moynalty");
