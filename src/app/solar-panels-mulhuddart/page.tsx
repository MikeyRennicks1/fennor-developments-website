...
export const metadata: Metadata = {
  title: "Solar Panels Mulhuddart | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Mulhuddart and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMulhuddartPage() {
  const location = getSolarLocationBySlug("mulhuddart");
