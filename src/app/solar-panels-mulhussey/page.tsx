...
export const metadata: Metadata = {
  title: "Solar Panels Mulhussey | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Mulhussey and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsMulhusseyPage() {
  const location = getSolarLocationBySlug("mulhussey");
