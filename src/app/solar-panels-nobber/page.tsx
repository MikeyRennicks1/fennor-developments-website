...
export const metadata: Metadata = {
  title: "Solar Panels Nobber | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Nobber and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsNobberPage() {
  const location = getSolarLocationBySlug("nobber");
