...
export const metadata: Metadata = {
  title: "Solar Panels Omeath | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Omeath and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsOmeathPage() {
  const location = getSolarLocationBySlug("omeath");
