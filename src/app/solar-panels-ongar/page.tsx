...
export const metadata: Metadata = {
  title: "Solar Panels Ongar | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Ongar and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsOngarPage() {
  const location = getSolarLocationBySlug("ongar");
