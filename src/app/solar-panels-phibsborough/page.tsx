...
export const metadata: Metadata = {
  title: "Solar Panels Phibsborough | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Phibsborough and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsPhibsboroughPage() {
  const location = getSolarLocationBySlug("phibsborough");
