...
export const metadata: Metadata = {
  title: "Solar Panels Portmarnock | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Portmarnock and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsPortmarnockPage() {
  const location = getSolarLocationBySlug("portmarnock");
