...
export const metadata: Metadata = {
  title: "Solar Panels Portrane | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Portrane and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsPortranePage() {
  const location = getSolarLocationBySlug("portrane");
