...
export const metadata: Metadata = {
  title: "Solar Panels Raheny | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Raheny and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsRahenyPage() {
  const location = getSolarLocationBySlug("raheny");
