...
export const metadata: Metadata = {
  title: "Solar Panels Ravensdale | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Ravensdale and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsRavensdalePage() {
  const location = getSolarLocationBySlug("ravensdale");
