...
export const metadata: Metadata = {
  title: "Solar Panels Reaghstown | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Reaghstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsReaghstownPage() {
  const location = getSolarLocationBySlug("reaghstown");
