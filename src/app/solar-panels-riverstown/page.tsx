...
export const metadata: Metadata = {
  title: "Solar Panels Riverstown | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Riverstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsRiverstownPage() {
  const location = getSolarLocationBySlug("riverstown");
