...
export const metadata: Metadata = {
  title: "Solar Panels Robinstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Robinstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsRobinstownPage() {
  const location = getSolarLocationBySlug("robinstown");
