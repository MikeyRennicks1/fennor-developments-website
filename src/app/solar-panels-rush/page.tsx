...
export const metadata: Metadata = {
  title: "Solar Panels Rush | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Rush and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsRushPage() {
  const location = getSolarLocationBySlug("rush");
