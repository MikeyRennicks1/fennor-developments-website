...
export const metadata: Metadata = {
  title: "Solar Panels Santry | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Santry and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsSantryPage() {
  const location = getSolarLocationBySlug("santry");
