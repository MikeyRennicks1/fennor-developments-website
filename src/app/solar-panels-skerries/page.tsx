...
export const metadata: Metadata = {
  title: "Solar Panels Skerries | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Skerries and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsSkerriesPage() {
  const location = getSolarLocationBySlug("skerries");
