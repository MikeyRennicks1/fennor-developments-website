...
export const metadata: Metadata = {
  title: "Solar Panels Skryne | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Skryne and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsSkrynePage() {
  const location = getSolarLocationBySlug("skryne");
