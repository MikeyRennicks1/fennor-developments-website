...
export const metadata: Metadata = {
  title: "Solar Panels Stabannon | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Stabannon and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsStabannonPage() {
  const location = getSolarLocationBySlug("stabannon");
