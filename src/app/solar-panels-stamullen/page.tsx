...
export const metadata: Metadata = {
  title: "Solar Panels Stamullen | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Stamullen and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsStamullenPage() {
  const location = getSolarLocationBySlug("stamullen");
