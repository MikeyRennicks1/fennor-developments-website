...
export const metadata: Metadata = {
  title: "Solar Panels Summerhill | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Summerhill and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsSummerhillPage() {
  const location = getSolarLocationBySlug("summerhill");
