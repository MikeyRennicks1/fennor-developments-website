...
export const metadata: Metadata = {
  title: "Solar Panels Sutton | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Sutton and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsSuttonPage() {
  const location = getSolarLocationBySlug("sutton");
