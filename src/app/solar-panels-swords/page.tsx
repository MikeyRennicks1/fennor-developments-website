...
export const metadata: Metadata = {
  title: "Solar Panels Swords | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Swords and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsSwordsPage() {
  const location = getSolarLocationBySlug("swords");
