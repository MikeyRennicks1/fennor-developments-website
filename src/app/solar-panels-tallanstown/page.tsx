...
export const metadata: Metadata = {
  title: "Solar Panels Tallanstown | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Tallanstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsTallanstownPage() {
  const location = getSolarLocationBySlug("tallanstown");
