...
export const metadata: Metadata = {
  title: "Solar Panels Termonfeckin | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Termonfeckin and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsTermonfeckinPage() {
  const location = getSolarLocationBySlug("termonfeckin");
