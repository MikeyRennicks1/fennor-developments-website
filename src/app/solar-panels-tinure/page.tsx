...
export const metadata: Metadata = {
  title: "Solar Panels Tinure | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Tinure and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsTinurePage() {
  const location = getSolarLocationBySlug("tinure");
