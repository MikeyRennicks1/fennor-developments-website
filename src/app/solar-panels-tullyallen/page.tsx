...
export const metadata: Metadata = {
  title: "Solar Panels Tullyallen | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Tullyallen and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsTullyallenPage() {
  const location = getSolarLocationBySlug("tullyallen");
