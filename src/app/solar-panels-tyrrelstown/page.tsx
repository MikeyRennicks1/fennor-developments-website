...
export const metadata: Metadata = {
  title: "Solar Panels Tyrrelstown | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Tyrrelstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsTyrrelstownPage() {
  const location = getSolarLocationBySlug("tyrrelstown");
