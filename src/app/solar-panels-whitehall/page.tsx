...
export const metadata: Metadata = {
  title: "Solar Panels Whitehall | Solar PV Installation Dublin | Fennor",
  description: "Professional solar panel installation in Whitehall and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsWhitehallPage() {
  const location = getSolarLocationBySlug("whitehall");
