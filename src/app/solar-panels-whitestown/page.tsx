...
export const metadata: Metadata = {
  title: "Solar Panels Whitestown | Solar PV Installation Louth | Fennor",
  description: "Professional solar panel installation in Whitestown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsWhitestownPage() {
  const location = getSolarLocationBySlug("whitestown");
