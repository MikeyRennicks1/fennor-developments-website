...
export const metadata: Metadata = {
  title: "Solar Panels Wilkinstown | Solar PV Installation Meath | Fennor",
  description: "Professional solar panel installation in Wilkinstown and surrounding areas. SEAI grant supported solar PV systems installed by Fennor.",
};

export default function SolarPanelsWilkinstownPage() {
  const location = getSolarLocationBySlug("wilkinstown");
